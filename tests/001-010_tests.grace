...
// Test 4 : OK (because x is dynamic, it can take ++ method)
var x := "Hello"
print(x)
x := x ++ " world."
print(x)
...
// Test 6 : FIXME (.not is not implemented for booleans)
//print(true.not)
var x := false
print(x.not)
print(x.not.not)
...
// Test 7 : FIXME (print can't take numbers)
var x := 4
print(x / 2 - 1)
print(x - 2 / 1)
//print(2 * 1 + 4 / x)
...
// Test 8 : FIXME (else is not implemented)
//if (true) then {
//    print("OK 1 then")
//} else {
//    print("Fail 1 then")
